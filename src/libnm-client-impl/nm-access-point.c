 ...
 * @ap: a #NMAccessPoint
 *
 * Gets the Wi-Fi Generation (802.11n, 802.11ac, 802.11ax, etc) of the access point.
 *
...
{
    g_return_val_if_fail(NM_IS_ACCESS_POINT(ap), NM_WIFI_GENERATION_UNKNOWN);
