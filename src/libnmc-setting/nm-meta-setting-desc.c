...
static const NMMetaPropertyInfo *const property_infos_GSM[] = {
    ...
    PROPERTY_INFO_WITH_DESC (NM_SETTING_GSM_APN_TYPE,
        .is_cli_option =                TRUE,
        .property_alias =               NM_SETTING_GSM_APN_TYPE,
        .prompt =                       N_("APN type"),
        .property_type =                &_pt_multilist,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA (
            PROPERTY_TYP_DATA_SUBTYPE (multilist,
                .get_num_fcn_u32 =      MULTILIST_GET_NUM_FCN_U32     (NMSettingGsm, nm_setting_gsm_get_num_apn_types),
                .add_fcn =              MULTILIST_ADD_FCN             (NMSettingGsm, nm_setting_gsm_add_apn_type),
                .remove_by_idx_fcn_u32 = MULTILIST_REMOVE_BY_IDX_FCN_U32 (NMSettingGsm, nm_setting_gsm_remove_apn_type),
                .remove_by_value_fcn =  MULTILIST_REMOVE_BY_VALUE_FCN (NMSettingGsm, nm_setting_gsm_remove_apn_type_by_value),
                .strsplit_plain =       TRUE,
            ),
            .values_static =            NM_MAKE_STRV ("default", "supl", "mms"),
        ),
    ),
    PROPERTY_INFO_WITH_DESC (NM_SETTING_GSM_MMSC,
        .is_cli_option =                TRUE,
        .property_alias =               NM_SETTING_GSM_MMSC,
        .prompt =                       N_("MMSC"),
        .property_type =                &_pt_gobject_string,
    ),
    PROPERTY_INFO_WITH_DESC (NM_SETTING_GSM_MMS_PROXY,
        .is_cli_option =                TRUE,
        .property_alias =               NM_SETTING_GSM_MMS_PROXY,
        .prompt =                       N_("MMS Proxy"),
        .property_type =                &_pt_gobject_string,
    ),
    PROPERTY_INFO_WITH_DESC (NM_SETTING_GSM_MMS_PORT,
        .is_cli_option =                TRUE,
        .property_alias =               NM_SETTING_GSM_MMS_PORT,
        .prompt =                       N_("MMS Proxy Port"),
        .property_type =                &_pt_gobject_int,
    ),
