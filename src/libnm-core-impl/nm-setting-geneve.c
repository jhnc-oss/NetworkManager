 ...
 * necessary for connection to GENVE interfaces.
 **/
...
nm_setting_geneve_class_init(NMSettingGeneveClass *klass)
{
     ...
     * -1 means inherit from outer packet, 0 means auto, 1-255 are fixed values.
     *
     * Since: 1.58
     **/
     ...
     * NMSettingGeneve:df:
     *
     * Specifies the Don't Fragment (DF) flag to use in outgoing packets.
     * 0 means unset, 1 means set, 2 means inherit from outer packet.
     *
     * Since: 1.58
     **/
    _nm_setting_property_define_direct_uint32(properties_override,
