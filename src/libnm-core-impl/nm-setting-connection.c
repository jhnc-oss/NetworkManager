...
nm_setting_connection_get_autoconnect_ports(NMSettingConnection *setting)
{
    g_return_val_if_fail(NM_IS_SETTING_CONNECTION(setting),
                         NM_SETTING_CONNECTION_AUTOCONNECT_PORTS_DEFAULT);
 ...
 * Since: 1.2
 *
 * Deprecated: 1.46. Use nm_setting_connection_get_autoconnect_ports() instead which
 * is just an alias.
 **/
...
{
    NMSettingConnectionAutoconnectPorts autoconnect;
...
nm_setting_connection_class_init(NMSettingConnectionClass *klass)
{
     ...
     * ---end---
     */
    prop_idx = _nm_setting_property_define_direct_enum_full(
        properties_override,
        obj_properties,
        NM_SETTING_CONNECTION_AUTOCONNECT_SLAVES,
        PROP_AUTOCONNECT_SLAVES,
     ...
     * Since: 1.46
     **/
    _nm_setting_property_define_direct_enum_full(
        properties_override,
        obj_properties,
        NM_SETTING_CONNECTION_AUTOCONNECT_PORTS,
        PROP_AUTOCONNECT_PORTS,
        NM_TYPE_SETTING_CONNECTION_AUTOCONNECT_PORTS,
        NM_SETTING_CONNECTION_AUTOCONNECT_PORTS_DEFAULT,
        NM_SETTING_PARAM_FUZZY_IGNORE,
