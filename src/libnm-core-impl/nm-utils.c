...
static const struct cf_pair table_5ghz[] = {
    ...
    {157, 5785}, {160, 5800}, {161, 5805}, {165, 5825}, {183, 4915}, {184, 4920}, {185, 4925},
    {187, 4935}, {188, 4945}, {192, 4960}, {196, 4980}, {0, 0}};
...
static const guint table_5ghz_freqs[G_N_ELEMENTS(table_5ghz)] = {
    ...
    5785, 5800, 5805, 5825, 4915, 4920, 4925, 4935, 4945, 4960, 4980, 0,
};
...
nm_utils_wifi_channel_to_freq(guint32 channel, const char *band)
{
    ...
    if (nm_streq(band, "5GHz") || nm_streq(band, "a")) {
    ...
    if (nm_streq(band, "2.4GHz") || nm_streq(band, "bg")) {
...
nm_utils_wifi_find_next_channel(guint32 channel, int direction, char *band)
{
    ...
    if (nm_streq(band, "6GHz")) {
        ...
        pair = &table_6ghz[0];
    } else if (nm_streq(band, "5GHz") || nm_streq(band, "a")) {
        ...
        pair = &table_5ghz[0];
    } else if (nm_streq(band, "2.4GHz") || nm_streq(band, "bg")) {
 ...
 *
 * Utility function to return 5 GHz Wi-Fi frequencies (802.115GHz band).
 *
 * Returns: zero-terminated array of frequencies numbers (in MHz)
 *
 * Since: 1.2
