...
static const struct cf_pair table_5ghz[] = {
    ...
    {34, 5170},  {36, 5180},  {38, 5190},  {40, 5200},  {42, 5210},  {44, 5220},
    {46, 5230},  {48, 5240},  {50, 5250},  {52, 5260},  {56, 5280},  {58, 5290},
    {60, 5300},  {64, 5320},  {100, 5500}, {104, 5520}, {108, 5540}, {112, 5560},
    {116, 5580}, {120, 5600}, {124, 5620}, {128, 5640}, {132, 5660}, {136, 5680},
    {140, 5700}, {149, 5745}, {152, 5760}, {153, 5765}, {157, 5785}, {160, 5800},
    {161, 5805}, {165, 5825}, {169, 5845}, {173, 5865}, {177, 5885}, {0, 0}};

static const guint table_5ghz_freqs[G_N_ELEMENTS(table_5ghz)] = {
    /* 5GHz band */
    5170, 5180, 5190, 5200, 5210, 5220, 5230, 5240, 5250, 5260, 5280, 5290,
    5300, 5320, 5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640, 5660, 5680,
    5700, 5745, 5760, 5765, 5785, 5800, 5805, 5825, 5845, 5865, 5885, 0,
};
...
{
    if (freq >= NM_UTILS_MIN_6GHZ && freq <= NM_UTILS_MAX_6GHZ)
        return "6GHz";
    else if (freq >= NM_UTILS_MIN_5GHZ && freq <= NM_UTILS_MAX_5GHZ)
        return "5GHz";
    else if (freq >= NM_UTILS_MIN_2GHZ && freq <= NM_UTILS_MAX_2GHZ)
        return "2.4GHz";
 ...
 * @channel: channel
 * @band: frequency band for wireless ("6GHz", "5GHz", "2.4GHz",
 * legacy "a", "bg")
 *
...
nm_utils_wifi_channel_to_freq(guint32 channel, const char *band)
{
    ...
    if (nm_streq0(band, "5GHz") || nm_streq0(band, "a")) {
    ...
    if (nm_streq0(band, "2.4GHz") || nm_streq0(band, "bg")) {
...
nm_utils_wifi_find_next_channel(guint32 channel, int direction, char *band)
{
    ...
    if (nm_streq0(band, "6GHz")) {
        ...
        pair = &table_6ghz[0];
    } else if (nm_streq0(band, "5GHz") || nm_streq0(band, "a")) {
        ...
        pair = &table_5ghz[0];
    } else if (nm_streq0(band, "2.4GHz") || nm_streq0(band, "bg")) {
 ...
 *
 * Utility function to return 5 GHz Wi-Fi frequencies.
 *
 * Returns: zero-terminated array of frequencies numbers (in MHz)
 *
 * Since: 1.2
 ...
 *
 * Utility function to return 6 GHz Wi-Fi frequencies (802.11ax, 802.11be band).
 *
 * Returns: zero-terminated array of frequencies numbers (in MHz)
 *
 * Since: 1.52
