...
static void
test_read_nbft_ipv4_static(gconstpointer user_data)
{
    ...
    nbft_connections = nmi_nbft_reader_parse(sysfs_dir, &hostname);
...
static void
test_read_nbft_ipv4_dhcp(gconstpointer user_data)
{
    const char    *sysfs_dir = user_data;
    NMConnection **nbft_connections;
    NMConnection  *connection;
...
static void
test_read_nbft_ipv6_static(gconstpointer user_data)
{
    const char    *sysfs_dir = user_data;
    NMConnection **nbft_connections;
    NMConnection  *connection;
...
static void
test_read_nbft_ipv6_auto(gconstpointer user_data)
{
    const char    *sysfs_dir = user_data;
    NMConnection **nbft_connections;
    NMConnection  *connection;
...
static void
test_read_nbft_vlan(gconstpointer user_data)
{
    const char    *sysfs_dir = user_data;
    NMConnection **nbft_connections;
    NMConnection  *connection;
...
main(int argc, char **argv)
{
    ...
    g_test_add_data_func("/initrd/nbft/ipv4-static",
                         TEST_INITRD_DIR "/nbft-ipv4-static",
                         test_read_nbft_ipv4_static);
    g_test_add_data_func("/initrd/nbft/ipv4-dhcp",
                         TEST_INITRD_DIR "/nbft-ipv4-dhcp",
                         test_read_nbft_ipv4_dhcp);
    g_test_add_data_func("/initrd/nbft/ipv6-static",
                         TEST_INITRD_DIR "/nbft-ipv6-static",
                         test_read_nbft_ipv6_static);
    g_test_add_data_func("/initrd/nbft/ipv6-auto",
                         TEST_INITRD_DIR "/nbft-ipv6-auto",
                         test_read_nbft_ipv6_auto);
    g_test_add_data_func("/initrd/nbft/vlan", TEST_INITRD_DIR "/nbft-vlan", test_read_nbft_vlan);
