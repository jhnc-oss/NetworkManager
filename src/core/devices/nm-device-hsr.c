...
update_properties(NMDevice *device)
{
    ...
    const NMPlatformLnkHsr *props = NULL;
    int                     ifindex;
...
get_property(GObject *object, guint prop_id, GValue *value, GParamSpec *pspec)
{
    ...
    switch (prop_id) {
    case PROP_PORT1:
        g_value_set_uint(value, priv->props.port1);
        break;
    case PROP_PORT2:
        g_value_set_uint(value, priv->props.port2);
        break;
...
static const NMDBusInterfaceInfoExtended interface_info_device_hsr = {
    .parent = NM_DEFINE_GDBUS_INTERFACE_INFO_INIT(
        ...
        .properties = NM_DEFINE_GDBUS_PROPERTY_INFOS(
            NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE("Port1", "u", NM_DEVICE_HSR_PORT1),
            NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE("Port2", "u", NM_DEVICE_HSR_PORT2),
...
nm_device_hsr_class_init(NMDeviceHsrClass *klass)
{
    ...
    obj_properties[PROP_PORT1] = g_param_spec_uint(NM_DEVICE_HSR_PORT1,
                                                   "",
                                                   "",
                                                   0,
                                                   G_MAXUINT32,
    ...
    obj_properties[PROP_PORT2] = g_param_spec_uint(NM_DEVICE_HSR_PORT2,
                                                   "",
                                                   "",
                                                   0,
                                                   G_MAXUINT32,
