...
// Generated with Cursor to see if it solves an issue quickly, need to review. Likely a simple implementation and mostly copied from other devices.
static gboolean
...
nm_device_geneve_class_init(NMDeviceGeneveClass *klass)
{
    ...
    // TODO: RR: Do we neeed all the functions that VXLAN implements?
