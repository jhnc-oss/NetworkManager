...
void nm_supplicant_interface_create_p2p_device_config(NMSupplicantInterface *self, char *wps_config_methods, char *wfd_device_name, GBytes *wfd_device_category, GBytes *wfd_vendor_extensions, guint goIntent, gboolean persistentReconnect);
