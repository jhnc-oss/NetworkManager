...
{
    nmtstp_env1_add_test_func("/link/qdisc/1", test_qdisc1, TRUE, FALSE);
    nmtstp_env1_add_test_func("/link/qdisc/fq_codel", test_qdisc_fq_codel, TRUE, FALSE);
    nmtstp_env1_add_test_func("/link/qdisc/sfq", test_qdisc_sfq, TRUE, FALSE);
    nmtstp_env1_add_test_func("/link/qdisc/tbf", test_qdisc_tbf, TRUE, FALSE);
}
