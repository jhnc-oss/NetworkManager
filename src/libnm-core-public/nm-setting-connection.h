...
#define NM_SETTING_CONNECTION_IP_PING_ADDRESSES_TIMEOUT               "ip-ping-addresses-timeout"
...
guint32 nm_setting_connection_get_ip_ping_addresses_timeout(NMSettingConnection *setting);
