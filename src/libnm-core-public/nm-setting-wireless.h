 ...
 * @NM_SETTING_WIRELESS_CHANNEL_WIDTH_160MHZ: use a 160MHz channel width
 * @NM_SETTING_WIRELESS_CHANNEL_WIDTH_320MHZ: use a 320MHz channel width
 *
...
typedef enum {
    ...
    NM_SETTING_WIRELESS_CHANNEL_WIDTH_160MHZ = 160,
    NM_SETTING_WIRELESS_CHANNEL_WIDTH_320MHZ = 320,
} NMSettingWirelessChannelWidth;
