...
#if NM_VERSION_MIN_REQUIRED >= NM_VERSION_1_50
#define NM_DEPRECATED_IN_1_50        G_DEPRECATED
#define NM_DEPRECATED_IN_1_50_FOR(f) G_DEPRECATED_FOR(f)
#else
#define NM_DEPRECATED_IN_1_50
#define NM_DEPRECATED_IN_1_50_FOR(f)
#endif

#if NM_VERSION_MAX_ALLOWED < NM_VERSION_1_50
#define NM_AVAILABLE_IN_1_50 G_UNAVAILABLE(1, 50)
#else
#define NM_AVAILABLE_IN_1_50
#endif

#if NM_VERSION_MIN_REQUIRED >= NM_VERSION_1_52
#define NM_DEPRECATED_IN_1_52        G_DEPRECATED
#define NM_DEPRECATED_IN_1_52_FOR(f) G_DEPRECATED_FOR(f)
#else
#define NM_DEPRECATED_IN_1_52
#define NM_DEPRECATED_IN_1_52_FOR(f)
#endif

#if NM_VERSION_MAX_ALLOWED < NM_VERSION_1_52
#define NM_AVAILABLE_IN_1_52 G_UNAVAILABLE(1, 52)
#else
...
#if NM_VERSION_MAX_ALLOWED < NM_VERSION_1_56_2
#define NM_AVAILABLE_IN_1_56_2 G_UNAVAILABLE(1, 56.2)
#else
#define NM_AVAILABLE_IN_1_56_2
#endif
